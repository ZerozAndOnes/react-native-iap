...
* @returns {Promise<boolean>}
*/
export var launchPriceChangeConfirmationAndroid = function (sku) {
    return Platform.select({
        ios: function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/, Promise.resolve()];
        }); }); },
        android: function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                checkNativeAndroidAvailable();
                return [2 /*return*/, RNIapModule.launchPriceChangeConfirmation(sku)];
            });
        }); },
    })();
};
...
var iapUtils = {
    ...
    launchPriceChangeConfirmationAndroid: launchPriceChangeConfirmationAndroid,
